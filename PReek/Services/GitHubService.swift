...
class GitHubService {
    static private let PUBLIC_GITHUB_BASE_URL = URL(string: "https://api.github.com")!
    ...
    static private func restApiUrl() throws -> URL {
    ...
    static private func sendRequest(request: URLRequest) async throws -> (Data, HTTPURLResponse) {
