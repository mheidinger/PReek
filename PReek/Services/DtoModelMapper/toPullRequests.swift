...
private func toPullRequest(dto: PullRequestDto, viewer: PullRequestDto.Actor) -> PullRequest {
...
func toPullRequests(dtos: [PullRequestDto], viewer: PullRequestDto.Actor) -> [PullRequest] {
